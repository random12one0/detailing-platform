...
|---|---|---|---|---|---|
| 118 | A setup form a new detailer runs through that collects everything the booking page needs to work — hours, services, add-ons, promo codes, business info, booking rules | o | **BUILT 2026-09-02** — `components/SetupForm.jsx` | Getting started | **Skippable, and resumable later** — his words, and both are built: *"I'll do this later"* on every step, and a *Finish setting up · N of 7 done* row on Business until it is finished or dismissed. Seven steps: services · add-ons · promo code · hours · where you work · your details · **your colour** (the seventh, which no design file named) |
| 119 | A guided walkthrough of the dashboard, highlighting one thing at a time | o | **BUILT 2026-09-02** — `components/Walkthrough.jsx` | Getting started | **Many short steps, no paragraphs, nothing combined** — his constraint, quoted at §9 Q1, and it is the specification: one sentence and one element a step, seven of them. **Staff get this and not row 118.** The count is honest per role and per dashboard — 7 for an owner with jobs, 6 on an empty one, 4 for staff |
