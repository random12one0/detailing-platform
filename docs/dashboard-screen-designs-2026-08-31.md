...
| **Booking rules** | The **superseded flat travel fee is deleted** — still editable, still holding $25, and no longer charged. | Part B row 5 / row 79. A number a screen offers to set and nothing reads is a lie with a text cursor in it. |
