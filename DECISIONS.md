...
template. One is light on purpose, which makes the booking page's *"reopen in
phase 3 if a tenant site turns out light"* a real 3.2 build. The rejected page
was deleted rather than kept: its only lesson is this paragraph.
